...
GCS_BUCKET = "earthquake_analy"
DATASET_ID = "historical_db"
TABLE_ID = "EQ_table_using_dataflow"
...
DATAFLOW_LANDING_LOCATION = "dataflow_bronz/landing/20241019/raw_data_fetched_TESTING.json"
DATAFLOW_STAGING_LOCATION = "gs://earthquake_analy/dataflow/staging"
DATAFLOW_SILVER_LAYER_PATH = "dataflow_silver/20241019/TESTING1"
TEMP_LOCATION = "gs://earthquake_analy/temp"
current_datetime = datetime.now().strftime('%Y%m%d-%H%M%S')

# Set up GCP credentials and configurations from config file
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = SERVICE_ACCOUNT_KEY
SERVICE_ACCOUNT_KEY = r"C:\Users\Ankush\PycharmProjects\EartQuakeProject\bwt-learning-1998-998550e304ba.json"
# Set up pipeline options
options = PipelineOptions(save_main_session=True, temp_location=TEMP_LOCATION)
google_cloud_options = options.view_as(GoogleCloudOptions)
google_cloud_options.project = PROJECT_ID
job_name = f"dataflow-earthquake-{current_datetime}"
google_cloud_options.job_name = job_name # f"all-tasks-with-single-py-file-finally-done"
...
class FetchAndUpload(beam.DoFn):
    def _init_(self, api_url, bucket_name, destination_file_name):
...
logging.info("Pipelines executedsuccessfully.")