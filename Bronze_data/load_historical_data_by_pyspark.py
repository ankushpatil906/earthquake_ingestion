...
if __name__ == "__main__":
    ...
    try:
        destination_blob_name=f'pyspark/Historical_Bronze_Data/landing/20241111/earthquake_raw.json'
    ...
    try:
        input_file = obj_util.read_data_from_gcs(
            bucket_name="eartquake_analysis1",
            source_blob_name=f'pyspark/Historical_Bronze_Data/landing/20241111/earthquake_raw.json'
        )
    ...
    destination_blob_name = f'pyspark/Historical_Silver_Data/silver/20241111/earthquake_silver'
    ...
    parquet_file_path = f"gs://{bucket_name}/pyspark/Historical_Silver_Data/silver/20241111/earthquake_silver/*.parquet"
